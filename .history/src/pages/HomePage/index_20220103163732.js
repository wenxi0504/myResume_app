...
import ProfolioLists from '../../components/ProfolioLists';
...
export default () => {
    return <div className={styles.wrap}>
       ...
       <p>Welcome to my personal profolio website. Please feel free to explore my website.</p>
